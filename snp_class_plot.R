...
p.out1 <- p.out +   geom_point(data = prop.out3[which(prop.out2$p.val.adj < 0.05 & prop.out2$snp_class == "exon"),],
...
ggsave(p.out1, file="~/Documents/UVM/spoa/figures/FigS1_class_sig_pvals.pdf", h=5, w=9)
